...
# ROC plotting and AUC claculating function
# ROC = reciever operating characteristic
# AUC = Area under the curve (Perfect = 1, Guessing = 0.5);
def plotROC(predStrength, classLabels):
    ...
    sortedIndicies = predStrength.argsort();
    fig = plt.figure();
    fig.clf();
    ax = plt.subplot(111);
    ...
    ax.axis([0,1,0,1]);
    plt.show();
    print("Area under the curve is: ", ySum*xStep);
