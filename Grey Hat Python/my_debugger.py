...
class debugger():
    ...
    def load(self,path_to_exe):
        ...
        if kernel32.CreateProcessA(path_to_exe.encode("ASCII"), None, None, None, None, creation_flags, None, None, byref(startupinfo), byref(process_information)):
            print("[*] We have successfully launched the process!")
            print("[*] PID: %d" % process_information.dwProcessId)

            # Obtain a valid handel to the newly created process and store it
            # for future access.
            self.h_process = self.open(process_information.dwProcessId)
    ...
    def attach(self, pid):
        ...
        # We attemp to attach to the process if this fails we exit the call.
    ...
    def get_debug_event(self):
        ...
        if kernel32.WaitForDebugEvent(byref(debug_event), INFINITE):
            ...
            print("[*] Continuing past breakpoint")
